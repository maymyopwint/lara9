    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.roles.update",[$role->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $role->title) }}" required disabled>
                @if($errors->has('title'))
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card">
                                <div class="card-header card-title">
                                    <div class="form-check">
                                        <input class="form-check-input check-all-group" type="checkbox" id="checkAll_{{ $prefix }}" disabled>
                                ...
                                <div class="card-body">
                                    @foreach ($permissions as $permission)
                                        <div class="custom-control custom-checkbox pt-1">
                                            <input type="checkbox" name="permissions[]" class="custom-control-input permission-checkbox" id="checkbox_{{$permission->id}}" value="{{$permission->id}}" @if($role->permissions->contains('id', $permission->id)) checked @endif disabled>
